...
void terminalUI() {
    ...
    std::cout << "Welcome to DHS4SLHA, a program for computing the naturalness measure Delta_HS (high-scale naturalness) in the MSSM\n"
         ...
         << "Supported models for the Delta_HS solver are MSSM EFT models.\n\n"
    ...
    while (userContinue) {
        ...
        */        
        ...
        vector<LabeledValueHS> dhslist = DHS_calc(first_GUT_BCs[26], first_SUSY_BCs[26] - first_GUT_BCs[26],
                                                    ...
                                                    high_prec_float(91.1876) * high_prec_float(91.1876), first_SUSY_BCs[43] * first_SUSY_BCs[43], first_radcorrs[0], first_radcorrs[1]);
