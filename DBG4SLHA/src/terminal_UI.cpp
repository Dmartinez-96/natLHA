...
void terminalUI() {
    ...
    std::cout << "Welcome to DBG4SLHA, a program for computing the naturalness "
         ...
         << "Delta_BG will be evaluated at the renormalization scale given by the\n"
         << "geometric mean of the stop masses\n"
         << "as calculated at tree level from the SLHA file to minimize logarithmic contributions.\n\n"
         << "Supported models for the Delta_BG solver are the CMSSM, NUHM(1,2,3,4), and pMSSM-19.\n\n"
