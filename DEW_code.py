...
# Stop squarks (sigmauu = sigmadd):

def sigmauu_stop(vHiggs, tanb, y_t, g, g_prime, theta_W, m_sqrd_stopGauge, m_stop_12sq, a_t, Q_renormSq):
    Sigmauu_stop  = (1/(16 * (np.pi)**2))*F(m_stop_12sq, Q_renormSq)
    return Sigmauu_stop
