...
if __name__ == "__main__":
    ...
    while userContinue:
        ...
        mean_stop_mass = np.sign(m_stop_1 * m_stop_2) * np.sqrt(np.abs(m_stop_1 * m_stop_2))
        ...
        if neg_mean_stop_mass_check == 1:
            ...
            print('WARNING!')
            print('WARNING!')
            print('WARNING! Possible negative pole mass in file: mt1(pole): ' + str(m_stop_1) + ', mt2(pole): ' + str(m_stop_2))
            print('WARNING!')
            print('WARNING!')
            print('WARNING!')
        ...
        del mbL, mbR, mtauL, mtauR, msupL, msupR, msdownL, msdownR, mselecL, mselecR, mselecneut, msmuneut, msstrangeL, msstrangeR, SLHA_scale_check, neg_mean_stop_mass_check, SLHA_scale, mean_stop_mass
